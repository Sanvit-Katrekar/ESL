...
wherein phrase 1, second phrase 2, phase 3, ..., phrase n, are all phrases present in the vocabulary provided to assistant.
...
output_dict = eval(output_str[start_index: end_index])
